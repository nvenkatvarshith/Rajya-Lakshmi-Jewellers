        ...
        <div>
            ...
            <div className="row justify-content-center mt-4 me-0">
                {rljProducts.map((product)=>{
                    return (
                        <div className="col-lg-3 col-md-6 col-sm-12 card border-0 p-2" key={product.id} id={product.id} onMouseOver={() => cardCSSUpdate(product.id)} onMouseOut={() => cardCSSBtnRemove(product.id)} style={{width: '21.5rem'}}>
